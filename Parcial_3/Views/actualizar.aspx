<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="actualizar.aspx.cs" Inherits="Parcial_3.Views.actualizar" %>
...
<body>
    <form id="form1" runat="server">
        <div class="form-container">
            ...
            <asp:Button ID="btnActualizar" CssClass="btn btn-custom" runat="server" Text="Agregar Videojuego" OnClick="btnActualizar_Click"/>
